...
|--------------------------------------------------------------------------
*/
$config['website_name'] = "Where's my Court?";
$config['webmaster_email'] = 'webmaster@gdf.my.id';
...
|--------------------------------------------------------------------------
*/
$config['autologin_cookie_name'] = 'wmcl';
...
$config['recaptcha_public_key'] = '6LfVOBgTAAAAABFdXCSqMxWU7OE5bPt8_Ydmr5k_';
$config['recaptcha_private_key'] = '6LfVOBgTAAAAAFEnkbOi9I5850W3XxbtEXEZzWfj';
...
$config['entities_pag'] = array(
		...
		'first_link' => "<span class='glyphicon glyphicon-step-backward'></span> First",
		'last_link' => "Last <span class='glyphicon glyphicon-step-forward'></span>",
		'prev_link' => "<span class='glyphicon glyphicon-chevron-left'></span>",
		'next_link' => "<span class='glyphicon glyphicon-chevron-right'></span>",

		'full_tag_open' => "<nav><ul class='pagination'>".PHP_EOL,
		'full_tag_close' => "</ul></nav>".PHP_EOL,
		'first_tag_open' => "<li>",
		'first_tag_close' => "</li>".PHP_EOL,
		'last_tag_open' => "<li>",
		'last_tag_close' => "</li>".PHP_EOL,
		'next_tag_open' => "<li>",
		'next_tag_close' => "</li>".PHP_EOL,
		'prev_tag_open' => "<li>",
		'prev_tag_close' => "</li>".PHP_EOL,
		'cur_tag_open' => "<li class='active'><a href='#'>",
		'cur_tag_close' => "<span class=\"sr-only\">(current)</span></a></li>".PHP_EOL,
		'num_tag_open' => "<li>",
		'num_tag_close' => "</li>".PHP_EOL,
	);
$config['persons_pag'] = array_merge($config['entities_pag'], array(
		'per_page' => 20,
		'num_links' => 3,
		'uri_segment' => 3
	));
